...
<body id="home">
  ...
  <div class="wrapper">
    ...
    <div class="col-lg pr-5 ml-2">
      <h2>
        <i class="fas fa-file-invoice mr-2 p-4 mt-5 ml-5"></i><span>Barang Masuk</span></a>
      </h2>
      <a href="input-barang-masuk.php" class="text-white btn btn-primary tambah"><i class="fas fa-plus-circle mr-2"></i>Tambah Barang Masuk</a>
      <a href="cetak-brg-msk.php" target="_blank"><button type="button" class="btn btn-success">Cetak</button></a>
          ...
          <?php if (mysqli_num_rows($result) > 0) : ?>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) : ?>
              <tr>
                ...
                <td><?= $row["jumlah"]; ?></td>
                <td>
                  <a href="hapus-data-masuk.php?id=<?= $row['idMasuk']; ?>" class="btn btn-danger text-white p-1" onclick="return confirm('Apakah anda yakin')"><i class="fas fa-trash-alt"></i></a>
                </td>
              </tr>
              <?php $i++; ?>
            <?php endwhile; ?>
