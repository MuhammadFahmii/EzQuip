<?php 
    ...
    function tambah($data){
        ...
        if($gambar==false){
            echo "
                <script>
                document.location.href='tambahDataBarang.php';
                </script>
            ";       
            return false;
        }
    ...
    function upload(){
        ...
        if($error===4){
            echo"
                <script>
                alert('Anda belum memasukkan foto');
                </script>
            ";
            return false;
        }
    ...
    function edit($data){
        ...
        $edit="UPDATE barang SET
            namaBarang='$namaBarang', jenisBarang='$jenisBarang', hargaJual='$hargaBarang', jumlah='$jumlah', gambar='$gambar' WHERE idBarang=$idBarang;
        ";
