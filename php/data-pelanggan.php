    ...
    <body id="home"> 
        ...
        <div class="wrapper">
            ...
            <div class="col-lg pr-5">
                <h2>
                    <i class="fas fa-users mr-2 p-4 mt-5 ml-5"></i><span>Data Pelanggan</span></a>
                </h2>                
                    ...
                    <tbody>
                        ...
                        <?php foreach($pelanggan as $p): ?>
                            <tr>
                                ...
                                <td><?= $p["noTelepon"]; ?></td>
                                <td><?= $p["alamat"];?></td>
                                <td><a href="hapusDataPelanggan.php?id=<?= $p['idPelanggan'];?>" class="btn btn-danger text-white p-1" onclick="return confirm('Apakah anda yakin')"><i class="fas fa-trash-alt"></i></a></td>
                            </tr>
                        <?php $i++; ?>
                        <?php endforeach; ?>
                    </tbody>
